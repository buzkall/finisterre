...
return [
    ...
    'subtasks' => [
        ...
        'forbidden'   => 'You are not allowed to change the subtasks of this task.',
    ],
    'subtask_changes' => [
        'subject'  => 'Checklist updated: :title',
        'greeting' => 'The checklist of ":title" has changed:',
        'done'     => ':title (done)',
        'cta'      => 'View task',
        'actions'  => [
            'added'       => 'Added: :title',
            'renamed'     => 'Renamed: :original_title → :title',
            'completed'   => 'Completed: :title',
            'uncompleted' => 'Reopened: :title',
    ...
    'settings' => [
        ...
        'subtasks_notify'                          => 'Notify the assignee of checklist changes',
        'subtasks_notify_help'                     => 'Emails the assignee when somebody else adds, renames, ticks or deletes one of their subtasks. Requires a queue worker and a shared cache store.',
        'subtasks_notification_delay_minutes'      => 'Grouping delay (minutes)',
        'subtasks_notification_delay_minutes_help' => 'Changes made within this many minutes of the first one are collected into a single email.',
