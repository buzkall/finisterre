...
return [
    ...
    'set_card_image'    => 'Usar como imagen de la tarjeta',
    'remove_card_image' => 'Quitar la imagen de la tarjeta',
    'reposition_cover'  => 'Reposicionar',
    'save_position'     => 'Guardar posición',
    'drag_cover'        => 'Arrastra la imagen para reposicionarla',
    'user_id'           => 'Creado por',
    ...
    'subtasks' => [
        ...
        'forbidden'   => 'No tienes permiso para modificar las subtareas de esta tarea.',
    ],
    'subtask_changes' => [
        'subject'  => 'Subtareas actualizadas: :title',
        'greeting' => 'La lista de subtareas de ":title" ha cambiado:',
        'done'     => ':title (hecha)',
        'cta'      => 'Ver tarea',
        'actions'  => [
            'added'       => 'Añadida: :title',
            'renamed'     => 'Renombrada: :original_title → :title',
            'completed'   => 'Completada: :title',
            'uncompleted' => 'Reabierta: :title',
    ...
    'settings' => [
        ...
        'section_subtasks'                         => 'Subtareas',
        'subtasks_notify'                          => 'Avisar a la persona asignada de los cambios en las subtareas',
        'subtasks_notify_help'                     => 'Envía un email a la persona asignada cuando otra añade, renombra, marca o elimina una de sus subtareas. Requiere un worker de colas y una caché compartida.',
        'subtasks_notification_delay_minutes'      => 'Retardo de agrupación (minutos)',
        'subtasks_notification_delay_minutes_help' => 'Los cambios hechos dentro de estos minutos desde el primero se agrupan en un solo email.',
