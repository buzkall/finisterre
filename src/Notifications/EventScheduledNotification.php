...
class EventScheduledNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->subject(__('finisterre::finisterre.events.notifications.scheduled_subject', ['title' => $this->event->title]))
            ->greeting(__('finisterre::finisterre.events.notifications.scheduled_greeting', ['title' => $this->event->title]))
            ->line(__('finisterre::finisterre.events.notifications.scheduled_time', [
